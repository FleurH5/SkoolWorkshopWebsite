document.addEventListener("DOMContentLoaded", () => {
        ...
        if (!token) {
          window.location.href =
            "http://127.0.0.1:5500/Login/login.html"; // Redirect de gebruiker naar de inlogpagina als er geen token is
        ...
        fetch(
          ...
          .catch((error) => {
            ...
            window.location.href =
              "http://127.0.0.1:5500/Login/login.html"; // Redirect de gebruiker naar de inlogpagina in het geval van een fout
          });
      });
